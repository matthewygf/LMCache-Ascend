...
PYBIND11_MODULE(c_ops, m) {
  ...
  m.def("multi_layer_kv_transfer_acl_batch", &multi_layer_kv_transfer_acl_batch,
  ...
  m.def("multi_layer_kv_transfer_acl_batch_sync",
        ...
        py::call_guard<py::gil_scoped_release>());
  m.def("multi_layer_kv_transfer_acl_batch_component_major",
        &multi_layer_kv_transfer_acl_batch_component_major,
        py::arg("key_value"), py::arg("key_value_ptrs"),
        py::arg("slot_mapping"), py::arg("paged_memory_device"),
        py::arg("page_buffer_size"), py::arg("direction"), py::arg("use_mla"),
        py::arg("kvcache_format_raw"), py::arg("k_hidden_dims") = 0,
